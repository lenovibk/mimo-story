...
Các file `design.md`, `app-readme.md`, `ios-capapp-spm-readme.md` là **bản
copy** để tiện tra cứu tập trung — file gốc trong `design/` và `app/` mới là
bản chính thức, chỉnh sửa ở đó rồi copy lại đây nếu cần.

Script hỗ trợ cho `story-pipeline.md` nằm ở [`scripts/stories/`](../scripts/stories/).
