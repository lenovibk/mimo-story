...
import vocabProgressRouter from "./routes/vocabProgress.js";
...
app.use("/api/stories/:storyId/vocabulary", vocabularyRouter);
app.use("/api/stories/:storyId/grammar", grammarRouter);
app.use("/api/children/:childId/vocab-progress", vocabProgressRouter);
